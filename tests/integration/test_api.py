...
class TestPredictEndpoint:
    ...
    def test_predict_invalid_json_returns_422(self, test_client):
        ...
        response = test_client.post("/predict", content="invalid json", headers=headers)
        assert response.status_code == 422
...
class DummyFailingModel:
    """Helper model class for testing 500 error handling."""
...
class TestErrorHandling:
    ...
    def test_unloaded_model_returns_503(
        self, test_client, sample_prediction_request, sample_batch_request
    ):
